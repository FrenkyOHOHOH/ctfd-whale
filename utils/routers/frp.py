...
class FrpRouter(BaseRouter):
    ...
    def access(self, container: WhaleContainer):
        if container.challenge.redirect_type == 'direct':
            return f'Web: <a target="_blank" href="http://{get_config("whale:frp_direct_ip_address", "127.0.0.1")}:{container.port}/">Link to the Challenge</a><br>nc {get_config("whale:frp_direct_ip_address", "127.0.0.1")} {container.port}'
